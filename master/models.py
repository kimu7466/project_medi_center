...
from .utils.genrate_unique_id import custom_filename, genrate_always_unique_id
...
class doctor(BaseClass):
    ...
    FILENAME_WORD = 'dp'
    profile = models.ImageField(upload_to=custom_filename, default=r'default_images\doctor-profile.png',null=True)
